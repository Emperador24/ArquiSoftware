...
\midrule
\endhead
CU-016 --- Gestión del Mercado Secundario \textit{(complejo)} &
...
CU-017 --- Gestión de Personal para Eventos \textit{(fusión de Administrar + Asignar Personal)} &
...
CU-018 --- Gestionar Cambios de Turno &
...
CU-019 --- Registrar Ingreso y Salida del Personal &
Control de asistencia vía QR/credencial y cálculo de horas trabajadas. &
App Móvil del Personal.\\[0.5em]
CU-020 --- Gestionar Evacuación ante Emergencias \textit{(complejo)} &
...
Nótese que \textbf{CU-020 es el único caso que toca las tres interfaces a la vez} (web
...
microservicios. Los cinco casos de uso asignados (CU-016 a CU-020) cubren de forma cohesiva el
