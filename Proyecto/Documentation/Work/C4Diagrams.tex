...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Diagrams/04-Panorama.png}
...
\textbf{Leyenda:} azul oscuro = persona, azul = sistema en alcance de este documento, gris = otro
sistema de la organización, gris claro = sistema externo.
...
\bottomrule
\caption{Secuencia de interacciones del diagrama de secuencia.}
\end{longtable}
